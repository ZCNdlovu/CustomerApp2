...
public class Main {
    public static void main(String[] args) {
        ICustomerRepository repo = CustomerRepository.getRepository();
        ...
        Customer get2 = repo.findById(cust2.getId());
                System.out.println("Name Found is : " +get.getEmailAddress());
        System.out.println("Name Found is : " +get2.getFirstName());


        repo.getAll().forEach(c -> System.out.println(c+ " " + c.getFirstName()) );
